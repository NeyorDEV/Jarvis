...
class JarvisAgent:
    ...
    def __init__(self,
                 ...
                 memory_file: str = "data/jarvis_memoire.json"):
    ...
    def system_prompt(self) -> str:
        base = (
            "Tu es JARVIS, assistant IA personnel cree par mylane.\n"
...
def main() -> None:
    ...
    parser.add_argument("--memory-file", default="data/jarvis_memoire.json", help="Memory file path.")
