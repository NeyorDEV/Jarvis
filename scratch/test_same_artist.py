...
# 3. Now open 1809 (track 2070327887)
print("\nOpening 1809 (track 2070327887)...")
subprocess.Popen([DEEZER_EXE, "deezer://track/2070327887"], cwd=DEEZER_DIR, shell=False)
time.sleep(6)
...
if btn2:
    print(f"Clicking play on 1809 page (Button Name: '{btn2.Name}')...")
    _clic_control(btn2)
    time.sleep(5)
